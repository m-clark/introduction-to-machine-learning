...
One can start with the <span class="pack">scikit</span>-learn module, using it much in the same way as was demonstrated with caret.  It will get you very far, but for some situations, you may need more heavy duty options like <span class="pack">tensorflow</span>, <span class="pack">Theano</span>, etc.
...
I wouldn't recommend a proprietary tool when better open source tools are available, but I will say **Matlab** is also very popular in machine learning, and specific areas like image processing. **Julia** has been coming along as well.  Of course for maximum speed people still prefer lower level languages like **C++**, **Java**, and **Fortran**. And for whatever reason, people are reinventing ML wheels in languages like **Javascript** and other languages.  See the [awesome list](https://github.com/josephmisiti/awesome-machine-learning) for more.
