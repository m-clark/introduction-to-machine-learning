...
<span class="emph">input, feature, attribute</span>: independent variable, predictor variable, column
...
<span class="emph">unsupervised</span>: no dependent variable; think clustering, PCA etc.
