...
So we can see that alcohol content and acidity are the most important, but what is the nature of the relationship? Partial dependence plots can allow us to understand the predictive effect of any particular covariate, controlling for the effects of others.  This is particularly important in the case where we have nonlinear relationships as we do here.
