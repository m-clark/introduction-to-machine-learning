...
Boosting can be applied to a variety of tasks and loss functions, and in general is highly resistant to overfitting.  A very popular implementation is [XGBoost](https://xgboost.readthedocs.io/en/latest/R-package/xgboostPresentation.html).  The following shows an implementation.
...
You can start your journey into this sort of stuff at http://deeplearning.net/, and I have a minimals demos for R and Python in the [appendix][Deep learning example].
