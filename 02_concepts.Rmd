...
From the above, we can see in this case that the penalized coefficients have indeed shrunk toward zero, while the residual sum of squares has increased just a tad.  On the test data however, the squared error loss is lower.
