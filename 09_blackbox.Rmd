...
<span class="marginnote"><img src="img/svm2d_temp.svg" style="display:block; margin: 0 auto;"></span>
<span class="marginnote"><img src="img/svm3d_temp.png" style="display:block; margin: 0 auto;"></span>

```{r svm_plot, echo=FALSE, eval=FALSE}
### svm plots
set.seed(123)
x = rnorm(50)
y = rnorm(50)
...
# 
# library(lattice)
# cloud(y~x+z, data=d, groups=lab, col=c("#FF5500", "#03b3ff"), pch=19, 
#       screen = list(z = -50, x = -90), 
#       pretty=F, par.box = c(col = "gray80"), par.settings = list(axis.line = list(col = "gray50")))
...
Support vector machines can provide very good prediction in a variety of settings, while do fairly poorly in others. They will often require a notable amount of tuning, whereas generalizations would esitmate such parameters as part of the process. In short, you will typically have better, more interpretable, and/or less computationally intensive options in most circumstances.
